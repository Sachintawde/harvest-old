...
<head>
   <meta name="google-site-verification" content="g0xPmxw5T5a1IhXkLrorpQS4_UzC7_3QKAMXN_QbPoY" />
	<meta charset="utf-8">
	<meta http-equiv="x-ua-compatible" content="ie=edge">
	<title>Harvest Green Montessori School | Richmond, Texas - 77406</title>
	<meta name="description" content="Welcome to the family of Harvest Green Montessori, best Montessori school in richmond. Montessori education for children aged 3 months to 6 years. Montessori primary school, summer school.">
    <meta name="author" content="harvestgreenmontessori.com">
    <meta name="keywords" content="Harvest Green Montessori, Montessori primary school, Montessori summer school ,Montessori education , Montessori education children, harvest green Montessori school, Montessori learning outcomes, Montessori certification Texas, Montessori uniform, Montessori school uniforms, Montessori materials, Montessori teachers, Montessori Admission ,Montessori learning , Montessori education, harvest green Montessori tuition, , best day care in richmond, katy and sugarland, best Montessori school in richmond, infant, toddler, Transition, Kindergarten , primary, Enrichment,  summer school program, healthy food, Summer camp, School age, Before and after school program, Best day care in Richmond, Early Childhood Education ,Preschool Program ,Childcare,Best Montessori school near me, ⁠daycare ,⁠nursery ,⁠infant, Toddler child care ,child development ,⁠learning center ,⁠curriculum ,⁠licensed daycare ,⁠quality care ,family child care ,⁠Nido day care ,⁠Montessori environment ,⁠neighborhood school ,harvest green school"/>
...
<body>
	...
	<div class="wrapper" id="wrapper">
		...
		<header id="header" class="jnr__header header--3 clearfix">
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12 d-flex justify-content-around align-items-center p-1">
							<p class="text-white">Welcome to Harvest Green Montessori School!</p>
							<ul class="dacre__social__link--2 d-none d-lg-flex justify-content-start">
					...
					<div class="row menu__separator">
						...
						<div class="col-md-9 col-lg-7 col-sm-12 col-12">
							<div class="jun__header__top__right">
								...
								<p><span class="fa fa-phone text-success"></span><br><a href="tel:2818197529" class="text-decoration-none">281-819-PLAY (7529)</a></p>
							</div>
						</div>
							...
							<div class="mainmenu__wrap">
								<nav class="mainmenu__nav" style="display: block;">
                                    <ul class="mainmenu">
                                        ...
                                        <li class="drop"><a href="#" onclick="return false;">Our School</a>
                                        ...
                                        <li class="drop"><a href="#" onclick="return false;">Our Program</a>
											...
											<?php
												foreach($this->program as $row){
													...
													echo'<li>
													<a href="'.base_url().'program/'.strtolower(str_replace(" ","-",$row->program_name)).'">'.$string.'</a>
													</li>';
												}
											?>
                                            </ul>
                                        </li>
                                        <li class="drop"><a href="#" onclick="return false;">Admission</a>
                                            <ul class="dropdown__menu">
												<li><a href="<?= base_url(); ?>Admission">Steps to Admission</a></li>
												<li><a href="<?= base_url(); ?>Enroll">How To Enroll</a></li>
                                            </ul>
                                        </li>
			...
			<div class="call_button my-2 d-flex justify-content-around">
			    <a href="tel:2818197529" class="text-white" style="border-radius:25px;background-color: #474aab !important;padding:6px 11px !important"><span class="fa fa-phone text-white"></span> 281-819-PLAY (7529)</a>
			    <div>
			        <a class="btn text-white" style="border-radius:90%;background-color: #474aab !important;" href="https://www.facebook.com/HGMMontessoriSchool" target="_blank"><i class="fa fa-facebook" style="padding:2px;"></i></a>
			        <a class="btn btn-danger" style="border-radius:90%;" href="https://instagram.com/" target="_blank"><i class="fa fa-instagram"></i></a>
			    </div>
			</div>
			<!-- End Mainmenu Area -->
		</header>
